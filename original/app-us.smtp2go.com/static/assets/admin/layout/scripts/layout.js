...
var Layout = (function () {
  ...
  var handleSidebarAndContentHeight = function () {
    ...
    if (
      ...
      if (body.hasClass("page-sidebar-fixed")) {
        ...
        if (
          $(window).width() > 1024 &&
          height + headerHeight + footerHeight < Metronic.getViewPort().height
        ) {
          height = Metronic.getViewPort().height - headerHeight - footerHeight;
        }
      }
  ...
  var handleSidebarMenu = function () {
    ...
    jQuery(".page-sidebar").on("click", " li > a.ajaxify", function (e) {
      ...
      if (
        Metronic.getViewPort().width < 992 &&
  ...
  var _calculateFixedSidebarViewportHeight = function () {
    var sidebarHeight =
      Metronic.getViewPort().height - $(".page-header").outerHeight();
  ...
  var handleTheme = function () {
    ...
    var setColor = function (color) {
      ...
      $("#style_color").attr(
        "href",
        layoutCssPath + "themes/" + color_ + ".css",
      );
      if (color == "light2") {
    ...
    if (Cookies && Cookies.get("style_color")) {
      setColor(Cookies.get("style_color"));
    }
  };
