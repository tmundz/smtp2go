...
var Metronic = (function () {
  ...
  var handleUniform = function () {
    ...
    var test = $(
      "input[type=checkbox]:not(.toggle, .make-switch), input[type=radio]:not(.toggle, .star, .make-switch)",
    );
    if (test.size() > 0) {
      test.each(function () {
  ...
  return {
    ...
    blockUI: function (options) {
      ...
      var html =
        '<div class="loading is-visible"> <div class="load-more load-centered"> <div class="loading-spinner"><div class="loader"><span class="icon-circles"> <span class="dot-circle pending"></span> <span class="dot-circle soft-bounced"></span> <span class="dot-circle hard-bounced"></span> <span class="dot-circle rejected"></span> <span class="dot-circle spam"></span> <span class="dot-circle delivered"></span> <span class="dot-circle unsubscribed"></span> <span class="dot-circle unblocked"></span> <span class="dot-circle opened"></span> <span class="dot-circle clicked"></span> </span></div></div> </div> <div class="loading-backdrop"></div></div>';
      /*
            if (options.iconOnly) {
    ...
    alert: function (options) {
      ...
      var html =
        '<div id="' +
        id +
        '" class="Metronic-alerts alert alert-' +
        options.type +
        ' fade in">' +
        (options.close
