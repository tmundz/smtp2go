    ...
    return (
      (n = (function () {
        ...
        return (
          ...
          (t.prototype._initWidth = function () {
            ...
            return this.$wrapper.is(":visible")
              ...
              : (t = i.setInterval(
                  (function (e) {
                    return function () {
                      return e.$wrapper.is(":visible")
                        ? (e._width(), i.clearInterval(t))
                        : void 0;
                    };
                  })(this),
                  50,
          ...
          (t.prototype._containerPosition = function (t, i) {
            return (
              ...
              "change.bootstrapSwitch": (function (t) {
                return function (i, n) {
                  ...
                  return (
                    ...
                    (s = t.$element.is(":checked")),
                    t._containerPosition(s),
                    s !== t.options.state
                      ? ((t.options.state = s),
                        t.$wrapper
          ...
          (t.prototype._getClasses = function (t) {
            ...
            for (n = [], s = 0, o = t.length; o > s; s++)
              ((i = t[s]), n.push("" + this.options.baseClass + "-" + i));
            return n;
          }),
          t
        );
        ...
        return (
          ...
          this.each(function () {
            ...
            return (
              ...
              a || t.data("bootstrap-switch", (a = new n(this, s))),
              "string" == typeof s ? (o = a[s].apply(a, i)) : void 0
            );
          }),
          o
        );
