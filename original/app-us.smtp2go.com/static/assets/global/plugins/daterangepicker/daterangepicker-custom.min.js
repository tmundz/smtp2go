!(function (t, e) {
  ...
  var a = function (a, i, s) {
    if (
      ...
      (this.leftCalendar = {}),
      (this.rightCalendar = {}),
      (this.isFormatContainsTime = void 0),
    ...
    var r = [t(0)];
    r.push(r[0].clone().add(1, "hours").add(30, "minutes"));
    var o,
      h,
      l,
      c = this,
      d = r.map(function (e) {
        return {
          original: e,
          parsed: t(e.format(c.locale.format), c.locale.format),
        };
      });
    if (
      ((this.isFormatContainsTime = d.every(function (t) {
        return (
          t.original.hours() === t.parsed.hours() &&
          t.original.minutes() === t.parsed.minutes()
        );
      })),
      ...
      "boolean" == typeof i.timePickerPadHours &&
        (this.timePickerPadHours = i.timePickerPadHours),
      ...
      for (var m = this.locale.firstDay; m > 0; )
        (this.locale.daysOfWeek.push(this.locale.daysOfWeek.shift()), m--);
    if (
      void 0 === i.startDate &&
      void 0 === i.endDate &&
      e(this.element).is(":text")
    ) {
      var p = e(this.element).val(),
        f = p.split(this.locale.separator);
      ((o = h = null),
        2 == f.length
          ? ((o = t(f[0], this.locale.format)),
            (h = t(f[1], this.locale.format)))
          : this.singleDatePicker &&
            "" !== p &&
            ((o = t(p, this.locale.format)), (h = t(p, this.locale.format))),
    ...
    if ("object" == typeof i.ranges) {
      for (l in i.ranges) {
        ...
        if (
          (this.maxSpan &&
            u &&
            o.clone().add(this.maxSpan).isAfter(u) &&
            (u = o.clone().add(this.maxSpan)),
          u && h.isAfter(u) && (h = u.clone()),
          !(
            (this.minDate &&
              h.isBefore(this.minDate, this.timepicker ? "minute" : "day")) ||
            (u && o.isAfter(u, this.timepicker ? "minute" : "day"))
          ))
        ) {
          var D;
          (D = document.createElement("textarea")).innerHTML = l;
          n = D.value;
          this.ranges[n] = [o, h];
        }
      }
      ...
      (this.showCustomRangeLabel &&
        (g +=
          ...
          "</li>"),
        (g += "</ul>"),
        this.container.find(".ranges").prepend(g));
    }
  ...
  return (
    (a.prototype = {
      ...
      renderCalendar: function (a) {
        ...
        for (
          var y = t([p, m, g, 12, o, h]), k = ((D = 0), 0), v = 0;
          D < 42;
          D++, k++, y = t(y).add(24, "hour")
        )
          (D > 0 && k % 7 == 0 && ((k = 0), v++),
            (i[v][k] = y.clone().hour(r).minute(o).second(h)),
            y.hour(12),
            this.minDate &&
              i[v][k].format("YYYY-MM-DD") ==
                this.minDate.format("YYYY-MM-DD") &&
              i[v][k].isBefore(this.minDate) &&
              "left" == a &&
              (i[v][k] = this.minDate.clone()),
            this.maxDate &&
              i[v][k].format("YYYY-MM-DD") ==
                this.maxDate.format("YYYY-MM-DD") &&
              i[v][k].isAfter(this.maxDate) &&
              "right" == a &&
              (i[v][k] = this.maxDate.clone()));
        "left" == a
        ...
        if (
          ...
          var H = this.startDate.clone().add(this.maxSpan).endOf("day");
          (C && !H.isBefore(C)) || (C = H);
        }
        for (v = 0; v < 6; v++) {
          ((Y += "<tr>"),
          ...
          for (k = 0; k < 7; k++) {
            var O = [];
            (i[v][k].isSame(new Date(), "day") && O.push("today"),
              i[v][k].isoWeekday() > 5 && O.push("weekend"),
              i[v][k].month() != i[1][1].month() && O.push("off", "ends"),
              this.minDate &&
                i[v][k].isBefore(this.minDate, "day") &&
                O.push("off", "disabled"),
              ...
              null != this.endDate &&
                i[v][k] > this.startDate &&
                i[v][k] < this.endDate &&
                O.push("in-range"));
            var W = this.isCustomDate(i[v][k]);
            !1 !== W &&
              ("string" == typeof W
                ? O.push(W)
        ...
        if ("right" != t || this.endDate) {
          ...
          for (
            ...
            var c,
              d = l;
            (this.timePicker24Hour ||
              (d = a.hour() >= 12 ? (12 == l ? 12 : l + 12) : 12 == l ? 0 : l),
              (c = this.timePickerPadHours && l < 10 ? "0" + l : l));
            var m = a.clone().hour(d),
              p = !1;
            (i && m.minute(59).isBefore(i) && (p = !0),
              s && m.minute(0).isAfter(s) && (p = !0),
              d != a.hour() || p
                ? (e += p
                    ? '<option value="' +
                      l +
          ...
          ((e += "</select>"),
            (e +=
              '<span class="time-divider">:</span><select class="minuteselect">'));
          for (l = 0; l < 60; l += this.timePickerIncrement) {
            var f = l < 10 ? "0" + l : l;
            ((m = a.clone().minute(l)), (p = !1));
            (i && m.second(59).isBefore(i) && (p = !0),
              s && m.second(0).isAfter(s) && (p = !0),
              a.minute() != l || p
                ? (e += p
                    ? '<option value="' +
                      l +
          ...
          if (((e += "</select>"), this.timePickerSeconds)) {
            e +=
              '<span class="time-divider">:</span><select class="secondselect">';
            for (l = 0; l < 60; l++) {
              ((f = l < 10 ? "0" + l : l), (m = a.clone().second(l)), (p = !1));
              (i && m.isBefore(i) && (p = !0),
                s && m.isAfter(s) && (p = !0),
                a.second() != l || p
                  ? (e += p
      ...
      elementChanged: function () {
        if (this.element.is("input") && this.element.val().length) {
          var e = this.startDate.clone(),
            a = this.endDate.clone(),
            i = this.element.val().split(this.locale.separator),
            s = null,
            n = null;
          (2 === i.length &&
            ((s = t(i[0], this.locale.format)),
            (n = t(i[1], this.locale.format))),
            (this.singleDatePicker || null === s || null === n) &&
              (n = s = t(this.element.val(), this.locale.format)),
            s.isValid() &&
              n.isValid() &&
              (this.isFormatContainsTime ||
                (s
                  .hours(e.hours())
                  .minutes(e.minutes())
                  .seconds(e.seconds())
