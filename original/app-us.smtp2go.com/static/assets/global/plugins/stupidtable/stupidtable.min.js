  ...
  c.fn.stupidsort = function (a) {
    ...
    if (null !== f) {
      var d = b.closest("table"),
        e = { $th: b, $table: d, datatype: f };
      d.stupidtable.settings ||
        (d.stupidtable.settings = c.extend(
          {},
          c.fn.stupidtable.default_settings,
        ));
      ...
      d.css("display");
      setTimeout(function () {
        d.stupidtable.settings.will_manually_build_table ||
          d.stupidtable_build();
        var a = l(e),
          a = m(a, e);
        ...
        .each(function (a, d) {
          ...
          c(d)
            ...
            .each(function (a, b) {
              ...
              "undefined" === typeof d &&
                ((d = c(b).text()), c(b).data("sort-value", d));
              e.columns.push(d);
            });
          b.push(e);
        });
  ...
  var l = function (a) {
      var b = a.$table.data("stupidsort_internaltable"),
        ...
        e = c.map(d, function (b, d) {
          ...
          e || 0 === e
            ? (f = c.eq(e))
            : ((f = c.siblings("#" + b)), (e = c.index(f)));
          return { index: e, $e: f };
        });
      b.sort(function (b, c) {
        for (
          var d = e.slice(0), g = a.compare_fn(b.columns[f], c.columns[f]);
          0 === g && d.length;
        ) {
          var g = d[0],
            h = g.$e.data("sort"),
            g = (0, a.$table.data("sortFns")[h])(
              b.columns[g.index],
              c.columns[g.index],
            );
          d.shift();
    ...
    k = function (a, b) {
      ...
      a
        ? (f = a)
        : ((f = a || d.data("sort-default") || e.ASC),
          d.data("sort-dir") &&
            (f = d.data("sort-dir") === e.ASC ? e.DESC : e.ASC));
      return f;
    },
    h = function (a) {
      var b = 0,
