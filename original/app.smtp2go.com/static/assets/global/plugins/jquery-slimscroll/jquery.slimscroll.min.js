        ...
        this.each(function () {
          ...
          function r(e, t, i) {
            ...
            if (
              (t &&
                ((o =
                  parseInt(M.css("top")) +
                  ((e * parseInt(a.wheelStep)) / 100) * M.outerHeight()),
                (o = Math.min(Math.max(o, 0), r)),
                (o = e > 0 ? Math.ceil(o) : Math.floor(o)),
                M.css({ top: o + "px" })),
              (v =
                parseInt(M.css("top")) / (S.outerHeight() - M.outerHeight())),
            ...
            ("scrollTo" in a && a.animate
              ? S.animate({ scrollTop: o })
              : S.scrollTop(o),
          ...
          function s() {
            window.addEventListener
              ? (this.addEventListener("DOMMouseScroll", o, !1),
                this.addEventListener("mousewheel", o, !1))
              : document.attachEvent("onmousewheel", o);
          }
          function l() {
            ((f = Math.max(
              (S.outerHeight() / S[0].scrollHeight) * S.outerHeight(),
              w,
            )),
              M.css({ height: f + "px" }));
          ...
          var u,
            ...
            S = e(this);
          if (
            (S.css("-ms-touch-action", "none"),
            S.parent().hasClass(a.wrapperClass))
          ) {
            var x = S.scrollTop();
            if (
              ((M = S.parent().find("." + a.barClass)),
              ...
              if ("scrollTo" in i) x = parseInt(a.scrollTo);
              else if ("scrollBy" in i) x += parseInt(a.scrollBy);
              else if ("destroy" in i)
                return (M.remove(), H.remove(), void S.unwrap());
              r(x, !1, !0);
            }
          } else {
            ...
            (H.css(D),
              ...
              window.navigator.msPointerEnabled &&
                (S.bind("MSPointerDown", function (e) {
              ...
              S.bind("touchmove", function (e) {
                if (
                  ...
                  var t =
                    (g - e.originalEvent.touches[0].pageY) / a.touchScrollStep;
                  (r(t, !0), (g = e.originalEvent.touches[0].pageY));
                }
              }),
              l(),
              "bottom" === a.start
                ? (M.css({ top: S.outerHeight() - M.outerHeight() }), r(0, !0))
                : "top" !== a.start &&
                  (r(e(a.start).position().top, null, !0),
