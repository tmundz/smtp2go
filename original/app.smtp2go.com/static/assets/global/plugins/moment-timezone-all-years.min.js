...
//! https://github.com/moment/moment-timezone/blob/develop/builds/moment-timezone-with-data-1970-2030.min.js
!(function (c, M) {
  "use strict";
  ...
  function o(c) {
    var M = 0,
      ...
      p = 0,
      i = 1;
    for (45 === c.charCodeAt(0) && (i = -(M = 1)); M < A.length; M++)
    ...
    for (
      var a,
        ...
        p = (function (c) {
          ...
          for (p in o) o.hasOwnProperty(p) && b.push(n[p]);
          return b;
        })(o),
        i = [],
        z = 0;
      ...
      for (a = new l(s(p[z])), A = 0; A < b; A++) a.scoreOffsetAt(o[A]);
      i.push(a);
    }
  ...
  function C(c) {
    ...
    return (
      A && !b.isMoment(c) && R(o) && o.add(A.parse(o), "minutes"),
      o.tz(a),
      o
    );
  }
  ((a < 2 || (2 == a && A < 6)) &&
    ...
    (f.prototype = {
      ...
      _index: function (c) {
        for (var M = +c, a = this.untils, A = 0; A < a.length; A++)
          if (M < a[A]) return A;
      },
      countries: function () {
        var M = this.name;
        return Object.keys(z).filter(function (c) {
          return -1 !== z[c].zones.indexOf(M);
        });
      },
      parse: function (c) {
        for (
    ...
    (C.names = function () {
      var c,
        M = [];
      for (c in n)
        n.hasOwnProperty(c) && (p[c] || p[i[c]]) && n[c] && M.push(n[c]);
      return M.sort();
    }),
    (C.Zone = f),
    (C.unpack = d),
    ...
    (C.zonesForCountry = function (c, M) {
      var a;
      if (((a = (a = c).toUpperCase()), !(c = z[a] || null))) return null;
      var A = c.zones.sort();
      return M
        ? A.map(function (c) {
